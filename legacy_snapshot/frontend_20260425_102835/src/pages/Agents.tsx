...
> = {
  ...
  offline: {
    label: '离线',
    color: '#6B7280',
    icon: <MinusCircleOutlined style={{ color: '#6B7280' }} />,
  },
};
...
export default function Agents() {
  ...
  const { agents, loading, selectedAgent, fetchAgents, setSelectedAgent } =
    useAgentStore();
  ...
  return (
    <div style={{ maxWidth: 1200 }}>
      ...
      <CreateAgentModal
        ...
        allowMutations={canManageAgents}
      />
      <AgentDetailDrawer
        agent={selectedAgent}
        open={drawerOpen}
