...
const ROUTING_STATUS_COLORS: Record<string, string> = {
  assigned: 'success',
            ...
            >
              ...
              >
                ...
                <Space wrap size={8}>
                  ...
                  {node.routing_reason ? (
                    <Tag color={ROUTING_STATUS_COLORS[node.routing_status ?? ''] ?? 'blue'}>
                      {`${node.routing_status ?? 'routing'}: ${node.routing_reason}`}
                    </Tag>
                  ) : null}
